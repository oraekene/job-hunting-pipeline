...
- [x] The feature folder contains a verification record listing each of tickets 01–07 with its seam result
- [x] All five seams green where applicable: `dry-run.py` 29/29, `regression-harness.py` 17/17, `install-check.py`, `hermes cron list` (26/26), `_inspect_state.py` + config read
- [x] The record notes any residual operational items (e.g. provider budget wait) and who owns them
